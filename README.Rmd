---
title: "Code for '*Functional Data Analysis in Biomechanics: A Concise Review of Core Techniques, Applications and Emerging Areas*'"
...
This repository contains `R` code for the SpringerBriefs publication ['Functional Data Analysis in Biomechanics'](https://link.springer.com/book/9783031688614). It is due to be published in October 2024.

![The front cover for ['Functional Data Analysis in Biomechanics'](https://link.springer.com/book/9783031688614).](images/book_frontcover.png)
