...
2.  **The Juggling Data** were initially downloaded from
    ...
    but the link is no longer working. <span style="color: red;">Note:
    Pending Permission from Prof. Jim Ramsay</span>. Therefore, we have
    uploaded a copy of the data to :open_file_folder:
    [**chapter-02/juggling-data/**](chapter-02/juggling-data/), which
    can be accessed from within this repository as follows:
